...
1. Call the Skill tool with `matt-writing-for-agents` for the writing style guide.
...
- Skills: use skills for docs (since their description goes into the agent's context window), or for user-invoked commands. Follow the advice in the `matt-writing-for-agents` skill.
