---
name: matt-setup-ts-deep-modules
...
For the vocabulary (deep module, interface, seam, depth), call the Skill tool with "matt-codebase-design" and use its language throughout.
